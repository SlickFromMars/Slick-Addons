package custom.animateatlas.displayobject;

import openfl.display.BitmapData;
import custom.animateatlas.JSONData.AnimationData;
import custom.animateatlas.JSONData.ElementData;
import custom.animateatlas.JSONData.LayerFrameData;
import custom.animateatlas.JSONData.LayerData;
import custom.animateatlas.JSONData.SymbolTimelineData;
import custom.animateatlas.JSONData.Matrix3DData;
import custom.animateatlas.JSONData.AtlasData;
import custom.animateatlas.JSONData.SymbolData;
import custom.animateatlas.JSONData.SpriteData;
import custom.animateatlas.HelperEnums.LoopMode;
import custom.animateatlas.HelperEnums.SymbolType;
