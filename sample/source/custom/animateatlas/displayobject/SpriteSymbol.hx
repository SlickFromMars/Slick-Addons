...
import custom.animateatlas.JSONData.SymbolInstanceData;
import custom.animateatlas.JSONData.LayerData;
import custom.animateatlas.JSONData.BitmapPosData;
import custom.animateatlas.JSONData.Matrix3DData;
import custom.animateatlas.JSONData.LayerFrameData;
import custom.animateatlas.JSONData.ColorData;
import openfl.geom.Matrix;
import openfl.geom.ColorTransform;
import custom.animateatlas.JSONData.FilterData;
